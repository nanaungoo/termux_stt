...
pub enum SttError {
    ...
    #[diagnostic(code(stt::model_error), help("Ensure the model directory exists and is valid."))]
    ModelError(String),

    #[error("Vosk recognizer error")]
    #[diagnostic(code(stt::recognizer_error), help("Failed to initialize the Vosk recognizer."))]
    RecognizerError,
